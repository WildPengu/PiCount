...
export interface ActiveShapeProps extends PieChartProps {
  cx: number;
  cy: number;
  midAngle: number;
  innerRadius: number;
...
export const PieChartComponent: React.FC<PieChartProps> = ({ dataChart }) => {
  ...
  const onPieEnter = (index: IndexType) => {
