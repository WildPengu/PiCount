...
export const ExpenseItem: React.FC<ExpenseItemProps> = ({ expense }) => {
  ...
  const selectedIcon = categoryInfo?.image
    ? iconMappings[categoryInfo.image]
    : undefined;
  ...
  return (
    <div className={`${styles.ExpenseItem} ${theme}Container`}>
      <div className={styles.ExpenseCategory}>
        ...
        <div className={styles.ExpenseAmount}>
          <p>
            - <span>{expense.amount}</span> ZŁ
          </p>
        </div>
      </div>
      <div className={styles.ExpenseDesc}>
        <p className={styles.Description}>{expense.desc}</p>
        <div
